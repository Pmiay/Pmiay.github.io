        ...
        miSkuFootDiv.appendChild(miSkuFootBrandDiv); */
            const miSkuFootNameDiv = document.createElement('div'); miSkuFootNameDiv.classList.add('item-list__body-wrap' );
             /*   const miSkuNameFirstDiv = document.createElement('div'); miSkuNameFirstDiv.classList.add( 'item-list__title')
                ...
                const miSkuSecondA = document.createElement('a'); miSkuSecondA.textContent = info.nombre;miSkuSecondA.href = "https://store.miyuro.one/" + info.producto + "/" + info.nombre.replace(/[^\w]/gi, '-') + ".html" ; //info.ofertaen;
...
//botton pedido
      ...
      //<a class="blantershow" href="https://wa.me/50764173737?text=https://store.miyuro.one/st34/Pedido.html%20%0D%0A*Esta%20disponible%20*" id="wbtn" target="_blank"> 
        const miSkuDivPedidoA = document.createElement('a'); miSkuDivPedidoA.classList.add('blantershow');
                                                             miSkuDivPedidoA.target='_blank';
                                                             miSkuDivPedidoA.href = "https://wa.me/50764173737?text=https://store.miyuro.one/" + info.producto + "/Pedido.html%20%0D%0A*Esta%20disponible*%20%0D%0A" + info.nombre +"%20%0D%0A" + info.precio.toFixed(2);
